  ...
  return (
    <div className="mt-12 flex flex-col justify-center align-center gap-8">
      ...
      <div className="flex gap-4 w-[100%] items-center align-center flex-col md:flex-row justify-center">
        ...
        <PaidToAmount comb={true} userKkmUrl={userKkmUrl} userReceiptsUrl={userReceiptsUrl} height="350px" id="PaidToWeek"  title="Выручка"  />
        <CarouselCard carousel={true} userKkmUrl={userKkmUrl} data={financeShare} title="Доли финансов" />
      </div>

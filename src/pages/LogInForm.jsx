  ...
  return (
    ...
    >
      <div className="max-w-md w-full bg-white p-8 border-8-grey rounded-2xl space-y-8">
        ...
        {!currentUrl.includes('register') && <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
        ...
        {currentUrl.includes('register') && <form className="mt-8 space-y-6" onSubmit={handleSubmitRegistration}>
          <input type="hidden" name="remember" value="true"/>
          <div className="rounded-xl flex flex-col gap-4 shadow-sm -space-y-px">
            <div>

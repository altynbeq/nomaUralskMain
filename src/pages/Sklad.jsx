  ...
  return (
    <div className="mt-12 flex w-[100%] flex-col justify-center  align-center gap-8">
      <div className="flex mt-5 w-[100%] flex-wrap xs:flex-col  gap-4 justify-center ">
        <SpisanieMonthChart short={true} userSpisanieUrl={userSpisanieUrl} title="Списания за месяц" series={spisanieBarSeries} />
      ...
      <div className="flex flex-col  md:w-[100%]  md:flex-row gap-2 justify-center align-center  items-center">
        <TableSort displayStats={true} width="25%" userKkmUrl={userKkmUrl} spisanieStats={productStats} rows={productsGridRows} columns={GridProductListCols} title="Продано товаров" />
      </div>
      <div className="flex flex-col  md:flex-row gap-2 justify-center align-center  items-center">
        <TableSort title="Списания" spisanieStats={spisanieStats} userSpisanieUrl={userSpisanieUrl} userKkmUrl={userKkmUrl} rows={tableRows} columns={GridSpisanieListCols} />
      </div>
    </div>
  );
}

...
const AccountingWorkers = () => {
    ...
    const [items, setItems] = useState([
        ...
        { icon: <Icons.openai />, id: "openai", name: 'Sophia Davis', rank: 'Cashier', level: 3, linkedTo: "sales1" },
        { icon: <Icons.user />, id: "user", name: 'James Wilson', rank: 'Inventory Coordinator', level: 3, linkedTo: "sales1" },
        { icon: <Icons.whatsapp />, id: "whatsapp2", name: 'Olivia Miller', rank: 'Shop Assistant', level: 3, linkedTo: "sales2" },
        { icon: <Icons.messenger />, id: "messenger2", name: 'Liam Taylor', rank: 'Shop Assistant', level: 3, linkedTo: "sales2" },
        { icon: <Icons.notion />, id: "notion2", name: 'Charlotte Anderson', rank: 'Customer Service Representative', level: 3, linkedTo: "sales2" },
        { icon: <Icons.openai />, id: "openai2", name: 'Ethan Moore', rank: 'Cashier', level: 3, linkedTo: "sales2" },
        { icon: <Icons.user />, id: "user2", name: 'Isabella Jackson', rank: 'Inventory Coordinator', level: 3, linkedTo: "sales2" }
    ]);

...
const CardWithBarChart = ({ title, series, dataKey, userKkmUrl }) => {
    ...
    return (
        <Card
            withBorder
            padding="lg"
            className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg my-3 p-4 text-center justify-center align-center w-[100%] md:w-[90%]  rounded-2xl subtle-border"
        >
            ...
            {!loading ? (
                <div ref={componentRef}>
                        ...
                        <div className="flex flex-row gap-4 justify-evenly">
                            ...
                            <div className="flex justify-center md:border-l-1  pl-2 flex-col text-start ">
                                ...
                                <p className="text-1xl font-semibold">
                                    {deals.leadsCount > 0 && stats.salesCount > 0
                                        ? ((deals.leadsCount * 100) / stats.salesCount).toFixed(2)
                                        : 0}
                                    %
                                </p>
                            </div>
                    ...
                    <Card.Section className="flex justify-between py-2 px-4 border-t border-gray-200 dark:border-gray-700"></Card.Section>

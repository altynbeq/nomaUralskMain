...
const DailySalesStats = ({ kkm }) => {
    ...
    return (
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg  p-4 text-center justify-center align-center w-[90%] md:w-[55%]  rounded-2xl subtle-border">

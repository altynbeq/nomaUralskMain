...
export default function AnimatedBeamMultipleOutputDemo({
    ...
    return (
        <div
            className={cn(
                "mt-10 md:mt-0 ml-auto mr-auto relative flex h-[500px] max-w-[80%] items-center justify-center overflow-hidden rounded-lg border bg-white p-10 md:shadow-xl",
                className,
            )}
            ref={containerRef}
        >
            <div className="flex size-full max-w-lg flex-col h-[a] items-stretch justify-between gap-10">
